...
public class DI_Systeme : MonoBehaviour
{
    [Header("References")]
    [SerializeField] private DammageIndicator indicatorPrefab = null;
    [SerializeField] private RectTransform holder = null;
    [SerializeField] private new Camera camera = null;
    [SerializeField] private Transform player = null;

    private Dictionary<Transform, DammageIndicator> Indicators = new Dictionary<Transform, DammageIndicator>();
    ...
    void Create(Transform target)
    {
        ...
        DammageIndicator newIndicator = Instantiate(indicatorPrefab, holder);
